...
<main class="svelte-adg0wd"><div class="outerDiv svelte-adg0wd"><div class="innerDiv svelte-adg0wd"><form method="post" action="?/signin"><h1 class="svelte-adg0wd">Login</h1>
				...
				<input type="submit" class="button svelte-adg0wd" value="Sign In">

				<div class="signswitch svelte-adg0wd"><p>Don&#39;t have an account?</p>
					<a href="/signup"><button class="svelte-adg0wd">Sign Up</button></a></div></form></div></div>
</main>`;
});
export {
  Page as default
